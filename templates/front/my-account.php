...
<div class="py-10" id="subscription-content">
  <div class="subscription-wrap mx-auto">
      <h3 class="rsp-h3 font-bold"><?php echo __( 'Sucesso!', 'recurring-subscription-plans' ); ?></h3>
      <div class="card subscription-card">
          <div class="alert alert-info alert-dismissible fade show mb-0" role="alert">
              <span class="message"><?php echo __( 'Parabéns, você agora é um assinante!', 'recurring-subscription-plans' ); ?></span>
              <span>Seu cadastro será ativo amanhã na data <strong><?php echo date('d/m/Y', strtotime('+1 days')); ?></strong>, enquanto isso faça download do aplicativo abaixo:</span>
          </div>
          <div class="mt-4 text-center">
            <h3 class="mb-4">Baixe agora mesmo</h3>
            <!-- App Store button -->
            <a href="https://apps.apple.com/br/app/sa%C3%BAde-24h/id1101572255" target="_blank" class="market-btn apple-btn" role="button">
              <span class="market-button-subtitle">Baixar em</span>
              <span class="market-button-title">App Store</span>
            </a>

            <!-- Google Play button -->
            <a href="https://play.google.com/store/apps/details?id=br.com.ambienteprd.saude&hl=pt_BR&gl=US" target="_blank" class="market-btn google-btn" role="button">
              <span class="market-button-subtitle">Baixar em</span>
              <span class="market-button-title">Google Play</span>
            </a>
          </div>
          <h5 class="mt-5 text-center">Perguntas frequentes</h5>
          <div class="accordion mt-2" id="accordionExample">
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                Porque meu cadastro ativa só no dia seguinte?
              </button>
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Precisamos analisar seus dados cadastrais para melhor atendê-lo. Enquanto você espera a ativação, poderá baixar o aplicativo <strong>Saude 24h</strong> para quando seu cadastro for ativado, você possa acessar imediatamente. Seu cadastro é acessado pelo CPF e um código é enviado para o seu celular.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                A cobrança é feita todo mês via cartão de crédito, sua assinatura pode ser cancelada a qualquer momento, sem multas ou taxas. Se você fez parte de alguma promoção de 30 dias gratuitos, sua cobrança só será feita após o periodo gratuito.
              </div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                Como usar meu plano de saúde?
              </button>
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                Você pode usufruir do seu plano de saúde diretamente pelo aplicativo <strong>Saúde 24h</strong>, o nosso site será apenas para informações cadastrais. No aplicativo você poderá marcar consultas, pesquisar as farmácias conveniadas, alterar os dados cadastrais entre outras vantagens.
              </div>
            </div>
          </div>
        </div>
